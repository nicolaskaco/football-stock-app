...
- [ ] **A1. Estado del jugador (activo / cedido / transferido / egresado / dado de baja)** — Add `status` field to `players`. PlayersTab filter by status; inactive hidden by default. Badge next to name (like injury icon).
