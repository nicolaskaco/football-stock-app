        ...
        <div className="p-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-xs text-blue-600 mt-1">
              Como Presidente de Categoría, los cambios en viáticos y contratos requieren aprobación.
            </p>
          </div>
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              disabled={!hasChanges}
              className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 font-semibold disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
